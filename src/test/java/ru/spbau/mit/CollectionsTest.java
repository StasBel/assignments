...
public class CollectionsTest {
    ...
    @Test
    public void testMap() {
        Iterable<Boolean> result = Collections.map(LESS_THEN_FIVE, a);
    ...
    public void testFilter() {
        Iterable<Integer> result = Collections.filter(LESS_THEN_FIVE, a);
    ...
    public void testTakeWhile() {
        Iterable<Integer> result = Collections.takeWhile(LESS_THEN_FIVE, a);
    ...
    public void testTakeUnless() {
        Iterable<Integer> result = Collections.takeUnless(LESS_THEN_FIVE, a);
